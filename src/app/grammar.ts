/**
 * This file exists just for the compiler to be able to get it statically.
 * The grammars should be loaded dinamically from src/front-end but I couldn't do it
 */

 export const simple_ast_grammar = `program
